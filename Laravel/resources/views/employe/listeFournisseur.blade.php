        ...
        <div class="col-md-9"> <!--Barre de navigation et Tableau-->
            ...
            <div class="row mt-4">
                ...
                <div class="col d-flex justify-content-end align-items-center">
                    <a href="{{route('parametres_systemes.edit')}}"><button style=" border-radius:5px;">Gestion des paramètres système</button></a>
                    <a href="/Admin/Gestion/Modeles"><button style=" border-radius:5px;">Gestion des modèles de courriels</button></a>
